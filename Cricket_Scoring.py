...
class App(ctk.CTk): 
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (MainMenuFrame, TeamInputFrame):
...
class MainMenuFrame(ctk.CTkFrame):
    ...
    def __init__(self, parent, controller):
        ctk.CTkFrame.__init__(self, parent, controller)
        self.controller = controller
        self.grid_columnconfigure(0, weight=1)

        # Play button
        play_button = ctk.CTkButton(self, text="Play", command=lambda: (controller.show_frame("TeamInputFrame")))
        ...
        # Quit button
        quit_button = ctk.CTkButton(self, text="Quit", command=lambda: self.closeprogram())
...
class TeamInputFrame(ctk.CTkFrame):
    ...
    def __init__(self, parent, controller):
        ...
        team2_label = ctk.CTkLabel(self.team2_frame, text="Team 2:")
        team2_label.grid(row=0, column=0, padx=10, pady=10)
        team2_label.configure(font=("Arial", 30))
        team2_entry = ctk.CTkEntry(self.team2_frame, width=250, height=50)
        team2_entry.grid(row=0, column=1, padx=10, pady=10)

        player2_label = ctk.CTkLabel(self.team2_frame, text="Player Names:")
        ...
        confirm_button = ctk.CTkButton(self, text="Confirm", command=lambda: controller.show_frame("TeamReviewFrame"))
